...
data_dir = 'C:/Users/User/AStar Intern/Prototype/RESTApi/Dataset/hymenoptera_data'
...
def trainmodel(fileList):

    image_datasets = datasets.ImageFolder(fileList, transforms.Compose([
        transforms.RandomResizedCrop(224),
        transforms.RandomHorizontalFlip(),
        transforms.ToTensor(),
        transforms.Normalize([0.485, 0.456, 0.406], [0.229, 0.224, 0.225])
